...
bool encoder_update_kb(uint8_t index, bool clockwise) {
    ...
    if (index == 0) {
        ...
        else if(right_encoder_mode % 4 == 1){
            if (clockwise) {
                tap_code(KC_RIGHT);
            } else {
                tap_code(KC_LEFT);
        ...
        else if(right_encoder_mode % 4 == 2){
            if (clockwise) {
                tap_code(KC_PGDN);
            } else {
                tap_code(KC_PGUP);
        ...
        else if(right_encoder_mode % 4 == 3){
            if (clockwise) {
                tap_code16(C(KC_TAB));
            } else {
